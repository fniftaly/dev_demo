<?php	
$apiUrl = 'http://api.textmunication.com/Message';
$shortCode = '87365';
...
$password = 'textmu1';
	...
	//echo $uri = $apiUrl . '?user=brandstandmm&pass=brandnostand&recipients=' . implode('&recipients=', $sendTo) . '&message=' . $sendMessage;
		...
		$ch = curl_init($uri);
			 curl_setopt ($ch, CURLOPT_POST, 1); //19252504282
 curl_setopt ($ch, CURLOPT_POSTFIELDS, "user=stouch&pass=stouch&recipients=12345654322&message=test");
