<?php
abstract class Application_Model_Smsabstract extends Application_Model_Abstract {
	/**
	 ...
	 * @var string
	 */
//	protected $_apiUrl = 'https://secure-mrr.air2web.com/a2w_preRouter/httpApiRouter';
	protected $_apiUrl = 'https://208.71.240.93/a2w_preRouter/httpApiRouter';
//	protected $_apiUrl = 'https://text.mes.syniverse.com/SMSSend'; 
	 ...
	 * @var string
	 */
	//protected $_shortCode = '66978'; // test shortcode, only keywords that will route to us are txttest, roberttest, ans jasontest
