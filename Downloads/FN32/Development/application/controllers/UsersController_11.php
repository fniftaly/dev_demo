...
//                 echo '<pre>'; print_r($this->view->industries);
//                 exit;
    ...
    public function editAction() {
        ...
        $key = '2d04af1f5c0553579c8d5ddf0a664dde';
        $encrypted = $user->password;
        $password =$user->password; //base64_decode($encrypted);//rtrim(mcrypt_decrypt(MCRYPT_RIJNDAEL_256, md5($key), base64_decode($encrypted), MCRYPT_MODE_CBC, md5(md5($key))), "\0");
...
//        exit;
    ...
    /**
     * this action retruns all industries 
     ...
     * @return json object
     */
//    public function allIndustryAction(){
//        $entity = new Application_Model_Userentity($this->user);
//        $indstruies = $entity->getIndustry();
//        
//        if(isset($indstruies)){
